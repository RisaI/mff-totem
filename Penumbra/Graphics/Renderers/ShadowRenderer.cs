    ...
    internal class ShadowRenderer : IDisposable
    {
        ...
        public void Render(Light light)
        {
            ...
            if (light.CastsShadows)
            {
                ...
                _engine.Device.DrawIndexedPrimitives(shadowVao.PrimitiveTopology, 0, 0, 1, 0, shadowVao.PrimitiveCount);
            ...
            if (light.CastsShadows || isShadowTypeSolid)
            {
				...
				_engine.Device.DrawIndexedPrimitives(hullVao.PrimitiveTopology, 0, 0, 1, 0, hullVao.PrimitiveCount);
            }
        }
