...
using Physics2D.Common.Decomposition.CDT;
using Physics2D.Common.Decomposition.CDT.Delaunay;
using Physics2D.Common.Decomposition.CDT.Delaunay.Sweep;
using Physics2D.Common.Decomposition.CDT.Polygon;
using Microsoft.Xna.Framework;

namespace Physics2D.Common.Decomposition
{
    /// <summary>
